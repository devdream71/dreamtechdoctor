...
class Doctor {
  ...
  final List<Map<String, dynamic>> schedule; // Parsing schedule into a list of maps
  ...
  factory Doctor.fromJson(Map<String, dynamic> json) {
    return Doctor(
      ...
      specialist: json['Specialist'] != null && json['Specialist'] is List
          ...
          : [],
      schedule: json['Shedule'] != null
          ? List<Map<String, dynamic>>.from(
              jsonDecode(json['Shedule']) as List<dynamic>)
          : [],
      symptoms: json['symptom'] != null && json['symptom'] is List
          ? List<String>.from(json['symptom'])
          : [],
      mobile: json['mobile'] ?? "",

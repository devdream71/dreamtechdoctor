// class DoctorUpdateModelResponse {
//   final String message;
//   final Doctor doctor;

//   DoctorUpdateModelResponse({required this.message, required this.doctor});

//   factory DoctorUpdateModelResponse.fromJson(Map<String, dynamic> json) {
//     return DoctorUpdateModelResponse(
